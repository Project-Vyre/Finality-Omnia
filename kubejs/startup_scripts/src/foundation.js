...
StartupEvents.registry('item', event => { // Register new items here event.create('example_item').displayName('Example Item')
  ...
  event.create('kubejs:deconstructor')
    ...
    .fireResistant(true)
    .glow(true)
  event.create('kubejs:reconstructor')
    .rarity('epic')
    .texture('kubejs:item/reconstructor')
    .maxStackSize(64)
    .fireResistant(true)
    .glow(true)
  event.create('kubejs:duplicator')
    ...
    .fireResistant(true)
    .glow(true)
  event.create('kubejs:quad_duplicator')
    .rarity('epic')
    .maxStackSize(1)
    .fireResistant(true)
    .glow(true)
  event.create('kubejs:true_duplicator')
    .rarity('epic')
    .maxStackSize(1)
    .fireResistant(true)
    .glow(true)
  event.create('kubejs:chronokinesis')
    .rarity('epic')
    .maxStackSize(1)
    .fireResistant(true)
    .glow(true)
...
StartupEvents.registry('block', event => {
  event.create('kubejs:duplicator_block')
...
StartupEvents.registry('fluid', event => {
  ...
  event.create('kubejs:shimmer')
    ...
    .bucketItem
    .texture('kubejs:item/shimmer_bucket')
    .glow(true)
  event.create('kubejs:crimson')
    .flowingTexture('kubejs:block/fluids/crimson_flow')
    .stillTexture('kubejs:block/fluids/crimson_still')
    .bucketItem
    .texture('kubejs:item/crimson_bucket')
    .glow(false)
  // Food related fluids
