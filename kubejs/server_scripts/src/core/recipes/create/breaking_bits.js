...
ServerEvents.recipes(event => {
  ...
  */
  ...
  let COLOR_MIXING = (output_color, color_one, color_two) => {
    ...
    ]).id(`kubejs:mixing/color_${output_color}`)
  }
  ...
  }).id('kubejs:mechanical_crafting/create_worldshaper')
  for (let i = 0; i < CMD.length; i++) {
    ...
    ]).keepHeldItem().id(`kubejs:binary_from_${insert}`)
    event.recipes.create.deploying([
      ...
      `kubejs:${insert}`,
      'kubejs:final_hoe'
    ]).keepHeldItem().id(`kubejs:structure_void_from_${insert}`)
  }
  event.recipes.create.deploying([
    ...
    'kubejs:command_block',
    'kubejs:final_axe'
  ]).keepHeldItem().id('kubejs:uncolored_rectangle')
  event.recipes.create.deploying([
    ...
    'kubejs:chain_command_block',
    'kubejs:final_axe'
  ]).keepHeldItem().id('kubejs:uncolored_circle')
  event.recipes.create.deploying([
  ...
  }).id('kubejs:blueprint_shape_base')
  event.recipes.create.deploying('kubejs:blueprint_shape', ['kubejs:blueprint_shape_base', 'kubejs:white_circle']).id('kubejs:blueprint_shape')
  event.recipes.create.mechanical_crafting('kubejs:cpu_foundation', [
    ' R',
    'R '
  ], {
    R: 'kubejs:green_rectangle_corner'
  }).id('kubejs:cpu_foundation')
  event.recipes.create.sequenced_assembly([
    ...
    event.recipes.create.deploying('kubejs:incomplete_cpu_substrate_shape', ['kubejs:incomplete_cpu_substrate_shape', 'kubejs:white_circle_corner']),
  ]).transitionalItem('kubejs:incomplete_cpu_substrate_shape').loops(1).id('kubejs:cpu_substrate_creation')
  event.recipes.create.sequenced_assembly([
    'kubejs:cpu_shape'
  ...
  ]).transitionalItem('kubejs:incomplete_cpu_shape').loops(2).id('kubejs:cpu_shape')
  ...
  }).id('kubejs:emitter_shape_base')
  event.recipes.create.deploying('kubejs:emitter_shape', ['kubejs:emitter_shape_base', 'kubejs:white_star']).id('kubejs:emitter_shape')
  event.shaped('kubejs:null_storage_block', [
    ...
    B: 'minecraft:barrel'
  }).id('kubejs:crafting/null_storage_block')
  ...
  ]).superheated().id('kubejs:mixing/qubit')
  event.recipes.create.sequenced_assembly([
    ...
    event.recipes.create.deploying('kubejs:stabilizing_qubit', ['kubejs:stabilizing_qubit', 'minecraft:blue_ice']),
    event.recipes.create.deploying('kubejs:stabilizing_qubit', ['kubejs:stabilizing_qubit', 'minecraft:blue_ice'])
  ]).transitionalItem('kubejs:stabilizing_qubit').loops(1).id('kubejs:sequenced_assembly/qubit_stabilization')
})