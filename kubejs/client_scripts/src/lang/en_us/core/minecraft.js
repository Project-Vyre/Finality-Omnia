...
ClientEvents.lang('en_us', event => {
  event.addAll('minecraft', {
    ...
    "block.minecraft.beacon.tooltip.behaviour1": "Requires a base built out of precious metals or gems to function! §fIron§r§7,§r §eGold§r§7,§r §bDiamond§r§7,§r §aEmerald§r §7and§r §8Netherite§r §7are valid materials.§r",
